...
void D::SetupFonts()
{
	...
	I::Surface->SetFontGlyphSet(F::Revue = I::Surface->Create_Font(), charenc("Impact"), 24, FW_DONTCARE, NULL, NULL, FONTFLAG_ANTIALIAS);
	I::Surface->SetFontGlyphSet(F::Meme = I::Surface->Create_Font(), charenc("Verdana Bold"), 10, FW_DONTCARE, NULL, NULL, FONTFLAG_ANTIALIAS);
	I::Surface->SetFontGlyphSet(F::ESP = I::Surface->Create_Font(), charenc("Verdana Bold"), 12, 500, NULL, NULL, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	I::Surface->SetFontGlyphSet(F::Watermark = I::Surface->Create_Font(), charenc("Verdana Bold"), 12, FW_DONTCARE, NULL, NULL, FONTFLAG_OUTLINE);
}
